...
| Memory repo reads/writes through pathname | Read operations use pinned `os.Root` handles; stable cross-operation identity requires PR 2c; writes require PR 5 | read containment implemented (PR 4); identity and writes planned |
